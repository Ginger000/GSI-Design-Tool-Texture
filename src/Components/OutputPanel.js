            ...
            <Grid item height={500} xs={12} md = {12} lg={12}>
                ...
                <Suspense fallback={null}>
                    ...
                    <group position={[0, 0, 3]}>
                        ...
                        <GSIplantedSurface surfaceType={surfaceType} position={[0,1.65,-6]} args={[4.002,0.3,6.01]} GSIRatio={loadingRatio} color={surfaceType === "planted" ? 'green': "lightblue"} prevGSIRatios={prevLoadingRatios} />
